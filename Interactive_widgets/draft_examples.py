...
st.number_input('나이를 입력해주세요.', min_value=0, step=1, key='4')
st.number_input('나이를 입력해주세요.', value=20, step=1, key='5')
st.number_input('나이를 입력해주세요.', step=0.1, format='%.1f', key='6')
